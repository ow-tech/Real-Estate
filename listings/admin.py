...
class ListingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Listing Details', {'fields':("realtor","title","developer","area", "price","description",'amenities',"kids_facilities","sports_facilities","swimming_pool","highlights","furnished","is_published","property_status", "is_handOver_in_12_months", "is_hot","is_villas_and_mansionettes",)}),
